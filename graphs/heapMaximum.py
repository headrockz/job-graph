...
class HeapMaximum:
    ...
    def addNodes(self, u):
        ...
        while True:
            ...
            if self.listHeapMaximum[primaryNodes - 1] >= self.listHeapMaximum[childerNodes - 1]:
                break
    ...
    def removeNode(self):
        ...
        while True:
            ...
            if childer + 1 <= self.nodes:
                if self.listHeapMaximum[childer] > self.listHeapMaximum[childer - 1]:
                    childer = childer + 1

            # Compered childer bigger with nodes
            if self.listHeapMaximum[position - 1] >= self.listHeapMaximum[childer - 1]:
                break
            else:
